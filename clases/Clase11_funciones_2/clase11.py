...
# Mostrar platos segun el horario seleccionado
if opcion_horario == "1":
    horario = "Desayuno"
    opcion_plato = ""
    while opcion_plato != "1" and opcion_plato != "2" and opcion_plato != "3":
    ...
    horario = "Almuerzo"
    opcion_plato = ""
    while opcion_plato != "1" and opcion_plato != "2" and opcion_plato != "3" and opcion_plato != "4":
...
# Validar respuesta de cumpleanos
cumple = ""
